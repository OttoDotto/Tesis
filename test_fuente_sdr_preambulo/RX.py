...
def analizar_trama(
    ...
    simbolos_datos = (
        simbolos_corregidos[
            n_preambulo:
            n_preambulo + CANTIDAD_BITS_DATOS
        ]
    )
...
print()
print("============================================")
print("RECEPTOR BPSK - DATOS REALES")
print("============================================")
...
try:
    ...
    while True:
        ...
        if (
            resultado_trama["errores_preambulo"]
            == 0
            and len(datos_rx)
            == TAMAÑO_PAQUETE_BYTES
        ):
